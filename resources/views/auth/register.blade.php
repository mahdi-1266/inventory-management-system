																	...
																	<div class="pt-0">
																			<form method="POST" action="{{ route('register') }}" class="my-4">
																					...
																					<div class="form-group mb-3">
																							...
																							<input class="form-control" type="text" name="name" required id="name" placeholder="Enter your password">
																					</div>
																					...
																					<div class="form-group d-flex mb-3">
																							<div class="col-sm-6 w-100">
																									@if (Route::has('password.request'))
																											<a class='text-muted fs-14' href="{{ route('password.request') }}">Forgot password? <span class="text-primary">Click Here</span></a>
																									@endif                           
																							</div>
																					</div>
									...
									<div class="col-xl-7">
											<div class="account-page-bg p-md-5 p-4">
													<div class="text-center">
															<h3 class="text-dark mb-3 pera-title">Log In To Get Access To The Dashboard</h3>
